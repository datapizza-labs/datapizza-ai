...
class StructResponder(PipelineComponent):
    ...
    def _run(self, *args, **kwargs) -> str:
        return self.client.structured_response(*args, output_cls=self.output_cls, **kwargs)
    
    async def _a_run(self, *args, **kwargs) -> str:
        return await self.client.a_structured_response(*args, output_cls=self.output_cls, **kwargs)
